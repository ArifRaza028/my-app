						...
						<div class="sidebar-inner slimscroll">
							<div id="sidebar-menu" class="sidebar-menu">
								<ul>
									...
									{/* <li class="submenu" >
										<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fe fe-document"></i> <span>Authentication</span></a>
										<ul class="dropdown-menu">
											<li class="active"><Link to="/Login1"> Login </Link></li>
											<li class="active"><Link to="/Register1"> Register </Link></li>
											<li class="active"><Link to="/Forgotpassword1"> Forgot Password </Link></li>
											<li class="active"><Link to="/Lockscreen"> Lock Screen </Link></li>
										</ul>
									</li> */}
									...
									<div class="row form-row">
										...
										<div class="col-12 col-sm-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="29th May 2021" />
											</div>
										</div>
