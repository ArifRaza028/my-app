                                ...
                                <div class="col-md-7 col-lg-8">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            {/* <!-- Checkout Form --> */}
                                            <form action="http://localhost:3000/Bookingsuccess?">
											...
											<!-- Terms Accept --> */}
                                                    <div class="terms-accept">
                                                        <div class="custom-checkbox">
                                                            ...
                                                            <label for="terms_accept">I have read and accept <Link to="#">Terms &amp; Conditions</Link></label>
                                                        </div>
                                                    </div>
                                                    {/* <!-- /Terms Accept -->
                                            ...
                                            <div class="booking-doc-info">
                                                ...
                                                <div class="booking-info">
                                                    ...
                                                    <div class="clinic-details">
                                                        <p class="doc-location"><i class="fas fa-map-marker-alt"></i> Pune, India</p>
                                                    </div>
                                                </div>
                                            </div>
                                            {/* <!-- Booking Doctor Info --> */}
                                            ...
                                            <div class="booking-summary">
                                                <div class="booking-item-wrap">
                                                    <ul class="booking-date">
                                                        <li>Date <span>16 May 2021</span></li>
