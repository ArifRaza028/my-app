                                            ...
                                            <li class="list-group-item">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="d-block mb-0">Dr.Bipin</h5>
                                                        <span class="d-block text-sm text-muted">Dentist</span>
                                                        <span class="d-block text-sm text-muted">14 May 2019 5.00 PM</span>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="list-group-item">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="d-block mb-0">Dr. Ganesh </h5>
                                                        <span class="d-block text-sm text-muted">Dentist</span>
                                                        <span class="d-block text-sm text-muted">12 May 2019 11.00 AM</span>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="card">
                                                                ...
                                                                <table class="table table-hover table-center mb-0">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    <Link to="/Doctorprofile" class="avatar avatar-sm mr-2">
                                                                                        <img class="avatar-img rounded-circle" src="assets/img/doctors/doctor-thumb-02.jpg" alt="User Image" />
                                                                                    </Link>
                                                                                    <Link to="/Doctorprofile">Dr. Bipin <span>Dental</span></Link>
                                                                                </h2>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <Link to="/Doctorprofile">Dr. Arif <span>Dental</span></Link>
                                                                                </h2>
                                                                            </td>
                                                                            <td>12 May 2021 <span class="d-block text-info">8.00 PM</span></td>
                                                                            <td>12 May 2021</td>
                                                                            <td>250</td>
                                                                            <td>14 May 2021</td>
                                                                            <td><span class="badge badge-pill bg-success-light">Confirm</span></td>
                                                                        ...
                                                                        {/* <tr>
                                                                            ...
                                                                            <td>11 May 2021 <span class="d-block text-info">11.00 AM</span></td>
                                                                            <td>10 May 2021</td>
                                                                            <td>400</td>
                                                                            <td>13 May 2021</td>
                                                                        ...
                                                                        {/* <tr>
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <Link to="/Doctoprofile">Dr.Bipin <span>Dental</span></Link>
                                                                                </h2>
                                                                            </td>
                                                                            <td>10 May 2021 <span class="d-block text-info">3.00 PM</span></td>
                                                                            <td>10 May 2021</td>
                                                                            <td>350</td>
                                                                            <td>12 May 2021</td>
                                                                            ...
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                                    <Link to="edit-prescription.html" class="btn btn-sm bg-success-light">
                                                                                        <i class="far fa-edit"></i> Edit
                                                                                    </Link>
                                                                        ...
                                                                        {/*  <tr>
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Loren Bivens <span>Dental</span></a>
                                                                                </h2>
                                                                            </td>
										...
										<!-- Prescription Tab --> */}
                                                <div class="tab-pane fade" id="pres">
                                                    <div class="text-right">
                                                        <Link to="/Addprescription" class="add-new-btn">Add Prescription</Link>
                                                    </div>
                                                    <div class="card card-table mb-0">
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <Link to="/Doctorprofile">Dr. Rohini <span>Dental</span></Link>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                                    ...
                                                                                    <a href="/Editprescription" class="btn btn-sm bg-success-light">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <Link to="/Doctorprofile">Dr. Jay <span>Cardiology</span></Link>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        {/*  <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Rieko Thrash <span>Urology</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Gennaro Weiner <span>Dental</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Ultima Douglas <span>Orthopaedics</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Neomah Oliveira <span>Neurology</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Falak Steel <span>Dermatology</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Molefi Snow <span>Dental</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Corynna Elmore <span>Dental</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <Link to="/Doctorprofile">Dr. Fahim <span>Dental</span></Link>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                                    ...
                                                                                    <a href="/Editprescription" class="btn btn-sm bg-success-light" data-toggle="modal" data-target="#add_medical_records">
                                                                                        <i class="fas fa-edit"></i> Edit
                                                                                    </a>
                                                                                    <a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
                                                                                        <i class="far fa-trash-alt"></i> Delete
                                                                ...
                                                                <!-- Add Medical Records Modal --> */}
                                                                        ...
                                                                        {/*  <tr>
                                                                            <td><Link  to="javascript:void(0);">#MR-0007</Link></td>
                                                                            <td>11 Nov 2021</td>
                                                                            <td>General Test</td>
                                                                        ...
                                                                        {/*   <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Gennaro Weiner <span>Ophthalmology</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <div class="table-action">
										...
										<!-- Billing Tab --> */}
                                                <div class="tab-pane" id="billing">
                                                    <div class="text-right">
                                                        <Link class="add-new-btn" to="/Addbilling">Add Billing</Link>
                                                    </div>
                                                    <div class="card card-table mb-0">
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                ...
                                                                <table class="table table-hover table-center mb-0">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <Link to="/Invoiceview">#INV-0010</Link>
                                                                            </td>
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    <Link to="/Doctorprofile" class="avatar avatar-sm mr-2">
                                                                                    ...
                                                                                    <Link to="/Doctorprofile"> Fahim <span>Dental</span></Link>
                                                                                </h2>
                                                                            </td>
                                                                            <td>450</td>
                                                                            <td>14 Nov 2019</td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <Link to="/Invoiceview">#INV-0009</Link>
                                                                            </td>
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    <Link to="/Doctorprofile" class="avatar avatar-sm mr-2">
                                                                            ...
                                                                            <td class="text-right">
                                                                                <div class="table-action">
                                                                                    ...
                                                                                    <a href="/Editbilling" class="btn btn-sm bg-success-light">
                                                                                        <i class="fas fa-edit"></i> Edit
                                                                                    </a>
                                                                                    <a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
                                                                                        <i class="far fa-trash-alt"></i> Delete
                                                                        ...
                                                                        {/*  <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Jerelyn Pino <span>Cardiology</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td>$150</td>
                                                                            <td>12 Nov 2019</td>
                                                                        ...
                                                                        {/*   <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Molefi Snow <span>Ophthalmology</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td>$600</td>
                                                                            <td>10 Nov 2019</td>
                                                                        ...
                                                                        {/* <tr>
                                                                            ...
                                                                            <td>
                                                                                <h2 class="table-avatar">
                                                                                    ...
                                                                                    <a href="doctor-profile.html">Dr. Corynna Elmore <span>#0010</span></a>
                                                                                </h2>
                                                                            </td>
                                                                            <td>$550</td>
                                                                            <td>5 Nov 2019</td>
                            ...
                            <form>
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <input type="text" class="form-control datetimepicker" value="01-08-2021" />
                                    </div>
                                    <div class="form-group">
