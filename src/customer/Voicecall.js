                                                        ...
                                                        <div class="navbar">
                                                            <div class="user-details mr-auto">
                                                                <div class="float-left user-img">
                                                                    <Link class="avatar avatar-sm mr-2" to="/Patientsprofile" title="Rohini">
                                                            ...
                                                            <ul class="nav float-right custom-menu">
                                                                <li class="nav-item dropdown dropdown-action">
                                                                    <Link to="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-cog"></i></Link>
                                                    ...
                                                    <div class="call-contents">
                                                        <div class="call-content-wrap">
                                                            <div class="voice-call-avatar">
                                                                ...
                                                                <span class="username">Dr. Bipin </span>
