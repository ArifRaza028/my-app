							...
							<div class="container-fluid">
										...
										<div class="chat-window">
											...
											<div class="chat-cont-left">
												<div class="chat-header">
													<span>Chats</span>
													<Link to="javascript:void(0)" class="chat-compose">
													...
													<div class="chat-scroll">
														<Link to="javascript:void(0);" class="media">
															...
															<div class="media-body">
																<div>
																	<div class="user-name">Ganesh</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Rochel Dickey</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Arlow Ebert </div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Niv Collazo</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Flo Sherrod</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Korva Weiner</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Jafit Gagne</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Rieko Thrash</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Aryo Pryor</div>
												...
												<div class="media-body">
													<div>
														<div class="user-name">Ieuan Folsom</div>
								...
								<!-- Chat Right --> */}
											<div class="chat-cont-right">
												<div class="chat-header">
													<Link id="back_user_list" to="javascript:void(0)" class="back-user-list">
