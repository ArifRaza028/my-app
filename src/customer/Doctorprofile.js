										...
										<div class="doc-info-left">
											...
											<div class="doc-info-cont">
												...
												<div class="clinic-details">
													<p class="doc-location"><i class="fas fa-map-marker-alt"></i> Pune,India  <a href="javascript:void(0);">Get Directions</a></p>
									...
									<div class="tab-content pt-0">
																...
																<li>
																	...
																	<div class="experience-content">
																		<div class="timeline-content">
																			<Link to="#/" class="name"> D.Y  Patil  Dental College</Link>
																			<div>BDS</div>
														...
														<div class="experience-box">
															<ul class="experience-list">
																<li>
																	...
																	<div class="experience-content">
																		<div class="timeline-content">
																			<Link to="#/" class="name">Glowing Smiles Family Dental Clinic</Link>
																...
																<li>
																	...
																	<div class="experience-content">
																		<div class="timeline-content">
																			<Link to="#/" class="name">Comfort Care Dental Clinic</Link>
																...
																<li>
																	...
																	<div class="experience-content">
																		<div class="timeline-content">
																			<Link to="#/" class="name">Dream Smile Dental Practice</Link>
													...
													<div class="col-md-6">
														<div class="clinic-content">
															...
															<div class="clinic-details mb-0">
																<h5 class="clinic-direction"> <i class="fas fa-map-marker-alt"></i> Pune ,India <br /><a href="javascript:void(0);">Get Directions</a></h5>
																<ul>
																	<li>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="clinic-content">
															...
															<div class="clinic-details mb-0">
																<p class="clinic-direction"> <i class="fas fa-map-marker-alt"></i> Pune ,India <br /><a href="javascript:void(0);">Get Directions</a></p>
																<ul>
																	<li>
																		<a href="assets/img/features/feature-01.jpg" data-fancybox="gallery2">
																			<img src="assets/img/features/feature-01.jpg" alt="Feature Image" />
										...
										<div role="tabpanel" id="doc_reviews" class="tab-pane fade">
											...
											<div class="widget review-listing">
													...
													<li>
														{/* <div class="comment">
															...
															<div class="comment-body">
																<div class="meta-data">
																	<span class="comment-author">Carter Guess</span>
														...
														<ul class="comments-reply">
															<li>
																{/* <div class="comment">
																	...
																	<div class="comment-body">
																		<div class="meta-data">
																			<span class="comment-author">Rochel Dickey</span>
												...
												<div class="all-feedback text-center">
													<Link to="#" class="btn btn-primary btn-sm">
														Show all feedback <strong>(16)</strong>
													</Link>
												</div>
												{/* <!-- /Show All --> */}
											...
											<div class="write-review">
												<h4>Write a review for <strong>Dr. Bipin</strong></h4>
														...
														<div class="widget-content">
															<div class="listing-hours">
																<div class="listing-day current">
																	<div class="day">Today <span>5 Nov 2021</span></div>
							...
							<div class="call-wrapper">
								<div class="call-inner">
									...
									<div class="call-items">
										...
										<a href="/Voicecall" class="btn call-item call-start"><i class="material-icons">call</i></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="call-box incoming-box">
							<div class="call-wrapper">
								<div class="call-inner">
									...
									<div class="call-items">
										<a href="javascript:void(0);" class="btn call-item call-end" data-dismiss="modal" aria-label="Close"><i class="material-icons">call_end</i></a>
										<a href="/Videocall" class="btn call-item call-start"><i class="material-icons">videocam</i></a>
									</div>
								</div>
							</div>
						</div>
