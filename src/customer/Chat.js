                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="active">
                                                            <Link to="/Chat">
                                                                ...
                                                                <span>Message</span>
                                                                <small class="unread-msg">1</small>
                                                            </Link>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <div class="chat-scroll">
                                                        <a href="javascript:void(0);" class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr.Fahim</div>
                                                        ...
                                                        {/*  <Link to="javascript:void(0);" class="media read-chat active">
                                                            <div class="media-img-wrap">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Bipin</div>
                                                        ...
                                                        <Link to="javascript:void(0);" class="media">
                                                            <div class="media-img-wrap">
                                                                <div class="avatar avatar-away">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. jay</div>
                                                        ...
                                                        {/*  <Link to="javascript:void(0);" class="media read-chat">
                                                            <div class="media-img-wrap">
                                                                <div class="avatar avatar-online">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Rieko Thrash</div>
                                                        ...
                                                        <a href="javascript:void(0);" class="media read-chat">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Molefi Snow</div>
                                                        ...
                                                        <a href="javascript:void(0);" class="media read-chat">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Ultima Douglas</div>
                                                        ...
                                                        {/*  <a href="javascript:void(0);" class="media read-chat">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Neomah Oliveira</div>
                                                        ...
                                                        <a href="javascript:void(0);" class="media read-chat">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Jillisa Tremblay</div>
                                                        ...
                                                        <a href="javascript:void(0);" class="media read-chat">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Gennaro Weiner </div>
                                                        ...
                                                        <a href="javascript:void(0);" class="media read-chat">
                                                            ...
                                                            <div class="media-body">
                                                                <div>
                                                                    <div class="user-name">Dr. Corynna Elmore</div>
                                                                        ...
                                                                        <div>
                                                                            <div class="chat-msg-attachments">
                                                                                <div class="chat-attachment">
                                                                                    ...
                                                                                    <Link to="#" class="chat-attach-download">
